...
![Illustration of the Virtual Network support for Power Platform (taken from Microsoft documentation)](/content/posts/05-vnet-support-illustration.png)
...
![Overview of the Virtual Network integration with Power Platform environments setup process (taken from Microsoft documentation)](/content/posts/05-vnet-integration-setup-overview.png)
...
![Power Platform Network Injection architecture overview with a single set of virtual networks](/content/posts/05-vnet-injection-single-set.png)
...
![Power Platform Network Injection architecture overview with peered virtual networks](/content/posts/05-vnet-injection-peered-networks.png)
...
![Power Platform Network Injection architecture overview following the hub and spoke model](/content/posts/05-vnet-injection-hub-spoke.png)
