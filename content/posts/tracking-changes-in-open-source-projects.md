...
![Changelog example - v0.1 of the rpothin/PowerPlatform-ALM-With-GitHub-Template GitHub repository](/content/posts/tracking-changelog-v01.png)
...
![Example of comparison between two versions of the olivierlacan/keep-a-changelog GitHub repository](/content/posts/tracking-version-comparison.png)
...
![Example of tag associated to a past commit](/content/posts/tracking-tag-past-commit.png)
