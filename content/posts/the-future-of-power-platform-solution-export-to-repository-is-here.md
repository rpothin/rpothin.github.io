...
![Mike Factorial sharing news on Twitter related to some pac solution commands](/content/posts/pac-solution-mike-factorial-tweet.png)
...
![Example of call to the pac solution clone command](/content/posts/pac-solution-clone-command.png)
...
![Example of call to the pac solution sync command](/content/posts/pac-solution-sync-command.png)
...
![Solution folder structure comparison depending on the method](/content/posts/pac-solution-folder-structure.png)
