...
This configuration of the cloud flow allows us to have the canvas app user in the "Created by" and "Modified by" columns of the "Contact" record that will be created (see ["Created by" / "Modified by" columns behavior in a canvas app + cloud flow + Dataverse scenario](/posts/created-by-modified-by-columns-behavior-in-a-canvas-app-cloud-flow-dataverse-scenario) for more details).
