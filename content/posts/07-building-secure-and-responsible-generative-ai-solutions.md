...
audioUrl: /content/posts/07-building-secure-and-responsible-generative-ai-solutions.m4a
---
...
![Time for ChatGPT to reach 1 million users compared to other services](/content/posts/07-chatgpt-1m-users.jpg)

![Count of monthly visitors of ChatGPT](/content/posts/07-chatgpt-monthly-visitors.jpg)
...
![Security and Responsible AI risks comparison](/content/posts/07-security-responsible-ai-risks.png)
...
![Overview of the threats on a Generative AI app ecosystem](/content/posts/07-threats-generative-ai-ecosystem.png)
...
![Overview of the Prompt injection effects](/content/posts/07-prompt-injection-effects.png)
...
![Overview of the risks related to plugins interactions](/content/posts/07-plugin-interactions-risks.png)
...
![MITRE ATLAS Matrix](/content/posts/07-mitre-atlas-matrix.png)
...
![OWASP Top 10 for LLM Applications](/content/posts/07-owasp-top-10-llm.png)
...
![LLM Application Data Flow](/content/posts/07-llm-application-data-flow.png)
...
![Allow the AI to use its own general knowledge setting set to Disabled in a Copilot](/content/posts/07-copilot-general-knowledge-disabled.png)
...
![Search public data options in the Create generative answers node in a Copilot topic](/content/posts/07-copilot-search-public-data.png)
...
![End user authentication options while configuring an action in a Copilot](/content/posts/07-copilot-action-auth-options.png)
...
![Selection of the GPT 4o model to configure a prompt](/content/posts/07-copilot-gpt4o-model.png)
...
![How a system prompt can be used to make the output more predictable](/content/posts/07-system-prompt-predictable.png)
...
![Famous quote from Kobe Bryant](/content/posts/07-kobe-quote.jpg)
...
![Example of adversarial prompt combining different languages and types of characters](/content/posts/07-adversarial-prompt-example.png)
