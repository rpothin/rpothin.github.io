...
![Microsoft Purview Compliance Audit Search interface](/content/posts/04-purview-compliance-audit-search.png)
...
![Example of an "Edited app permission" activity in Microsoft Purview Compliance](/content/posts/04-purview-compliance-edited-app-permission.png)
...
![Example of an "API created" activity in Microsoft Purview Compliance](/content/posts/04-purview-compliance-api-created.png)
...
![Example of an "Updated DLP Policy" activity in Microsoft Purview Compliance](/content/posts/04-purview-compliance-updated-dlp-policy.png)
...
![Illustration of a user going through multiple lists of contacts using different approaches](/content/posts/04-purview-compliance-user-contacts-illustration.png)
...
![Example of a "Launched app" activity in Microsoft Purview Compliance](/content/posts/04-purview-compliance-launched-app.png)
...
![Environment configuration to send audit logs to Microsoft Purview Compliance](/content/posts/04-purview-compliance-env-config-audit-logs.png)
...
![Contact table configured to generate audit logs for Retrieve and RetrieveMultiple activities](/content/posts/04-purview-compliance-contact-table-audit-logs.png)
