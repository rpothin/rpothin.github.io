...
![Overview of the position of Defender for Cloud Apps between enterprise users and cloud applications](/content/posts/dcfca-overview.png)
...
![Azure AD Conditional Access policy configuration to redirect users to Defender for Cloud Apps](/content/posts/dcfca-aad-ca-redirect-policy.png)
...
![App to consider in a Defender for Cloud Apps access control to target Dataverse / model driven applications](/content/posts/dcfca-target-app.png)
...
![Defender for Cloud Apps access control example — Block if access not from a supported device](/content/posts/dcfca-access-control-block.png)

![Example of message a user would see in this scenario](/content/posts/dcfca-block-message.png)
...
![Example of Defender for Cloud Apps session policy — Part 1](/content/posts/dcfca-session-policy-part1.png)

![Example of Defender for Cloud Apps session policy — Part 2](/content/posts/dcfca-session-policy-part2.png)
...
![Defender for Cloud Apps session policy welcome page accessing a model driven app](/content/posts/dcfca-session-policy-welcome.png)
...
![Example of application URL going through Defender for Cloud Apps as a reverse proxy](/content/posts/dcfca-reverse-proxy-url.png)

In our case, if a user tries to download a file, they will be blocked and see a configured error message.

![Example of message displayed to a user trying to download a file](/content/posts/dcfca-download-block-message.png)
...
![Alert configuration on a Defender for Cloud Apps policy](/content/posts/dcfca-alert-config.png)
...
![Defender for Cloud Apps alerts triggered by tests of an access policy](/content/posts/dcfca-alerts-triggered.png)

![Details of a Defender for Cloud Apps alert triggered by tests of an access policy](/content/posts/dcfca-alert-details.png)

![Defender for Cloud Apps incidents triggered by tests of an access policy](/content/posts/dcfca-incidents-triggered.png)

![Example of a Defender for Cloud Apps incident triggered by tests of an access policy](/content/posts/dcfca-incident-example.png)
...
![Example of activity logs in Defender for Cloud Apps to help you identify new policies to configure](/content/posts/dcfca-activity-logs.png)

![Example of query ran in the Advanced Hunting section of Defender for Cloud Apps](/content/posts/dcfca-advanced-hunting.png)
