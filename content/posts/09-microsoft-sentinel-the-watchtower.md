...
audioUrl: /content/posts/09-microsoft-sentinel-the-watchtower.m4a
---
...
![Microsoft Sentinel Workspace with the Microsoft Business Applications solution installed](/content/posts/09-sentinel-workspace-business-apps.png)
...
![Example of the Microsoft Dataverse data connector connected](/content/posts/09-sentinel-dataverse-connector.png)
...
![Microsoft Business Applications solution's components list](/content/posts/09-sentinel-business-apps-components.png)
...
![Example of the output of the MSBizAppsOrgSettings parser](/content/posts/09-sentinel-orgssettings-parser.png)
...
![Dataverse — Organization settings modified analytics rule once created from the solution](/content/posts/09-sentinel-analytics-rule.png)

![Incident generated by the Dataverse — Organization settings modified analytics rule](/content/posts/09-sentinel-incident.png)

![Investigation view accessible from an incident](/content/posts/09-sentinel-investigation-view.png)
...
![Dataverse: Add user to blocklist using Teams approval workflow configured](/content/posts/09-sentinel-playbook-blocklist.png)
...
![Run playbook from incident](/content/posts/09-sentinel-run-playbook.png)

![Example of an approval request generated by the manually triggered playbook](/content/posts/09-sentinel-approval-request.png)
...
![Hunt using Dataverse — Cross-environment data export activity hunting query](/content/posts/09-sentinel-hunting-query.png)
