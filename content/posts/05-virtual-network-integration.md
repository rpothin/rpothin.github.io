...
date: 2024-09-23
tags: [power-platform, security, virtual-network, azure, infrastructure-as-code, series-power-platforms-protection]
...
![Illustration of the Virtual Network support for Power Platform (taken from Microsoft documentation)](/content/posts/power-platform-protection/05-vnet-support-illustration.png)
...
![Overview of the Virtual Network integration with Power Platform environments setup process (taken from Microsoft documentation)](/content/posts/power-platform-protection/05-vnet-integration-setup-overview.png)
...
![Power Platform Network Injection architecture overview with a single set of virtual networks](/content/posts/power-platform-protection/05-vnet-injection-single-set.png)
...
![Power Platform Network Injection architecture overview with peered virtual networks](/content/posts/power-platform-protection/05-vnet-injection-peered-networks.png)
...
![Power Platform Network Injection architecture overview following the hub and spoke model](/content/posts/power-platform-protection/05-vnet-injection-hub-spoke.png)
