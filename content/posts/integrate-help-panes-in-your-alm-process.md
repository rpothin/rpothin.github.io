...
We have seen in a [previous article](/posts/configure-help-panes-in-dynamics-365) how it is pretty simple to configure Help Panes in a model-driven app and how it can help you improve user adoption. But there is more!
...
!["Help Pages" section in a solution open in classic mode](/content/posts/alm-help-pages-solution-classic.png)
...
1. In the **Help Pages** section of your solution (classic mode), click **Add Existing**
   ...
   ![Click on the "Add Existing" button](/content/posts/alm-help-pages-add-existing.png)

2. Select the Help Pages you want to include

   ![Select the Help Pages you want to have in the solution](/content/posts/alm-help-pages-select.png)

Don't forget to **save** and **publish** your changes to the solution.

![Verification of the presence of the Help Pages in the solution](/content/posts/alm-help-pages-solution-verify.png)
...
1. In the **Help Pages** section of your solution, click **New**
   ...
   ![Click on the "New" button](/content/posts/alm-help-pages-new-button.png)

### Help Page Form Fields

![Help Page form to complete](/content/posts/alm-help-page-form.png)

- **Display Name**: Title displayed at the top of the Help Pane

  ![Title of the Help Pane configured in the "Display Name" field of the Help Page record](/content/posts/alm-help-page-display-name.png)

- **Path**: Defines the page where the Help Pane will be shown

  ![Decomposition of Path examples](/content/posts/alm-help-page-path-decomposition.png)
...
![Example of a Help Page record](/content/posts/alm-help-page-record-example.png)
