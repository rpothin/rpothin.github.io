...
![Power Platform Support — User configuration validation — Initialization](/content/posts/notebooks-pps-validation-init.png)

![Power Platform Support — User configuration validation — Get token](/content/posts/notebooks-pps-validation-token.png)

![Power Platform Support — User configuration validation — Get user configuration](/content/posts/notebooks-pps-validation-get-config.png)
...
![.Net Interactive Notebooks VS Code extension — Setup result](/content/posts/notebooks-vscode-extension-setup.png)
...
![.Net Interactive Notebook in VS Code — "Hello world!" test](/content/posts/notebooks-hello-world.png)
...
![Power Platform Notebook Demonstration — Initialization](/content/posts/notebooks-demo-init.png)
...
![Power Platform Notebook Demonstration — Connect to Dataverse environment](/content/posts/notebooks-demo-connect-dataverse.png)
...
![Power Platform Notebook Demonstration — Search user](/content/posts/notebooks-demo-search-user.png)

![Power Platform Notebook Demonstration — Display user details](/content/posts/notebooks-demo-user-details.png)

![Power Platform Notebook Demonstration — Get user security roles](/content/posts/notebooks-demo-get-security-roles.png)

![Power Platform Notebook Demonstration — Display user security roles details](/content/posts/notebooks-demo-security-roles-details.png)
...
![Power Platform Notebook Demonstration — Variable from C# to PowerShell](/content/posts/notebooks-demo-csharp-to-powershell.png)
