...
![One version of my resume built with the Power Platform](/content/posts/resume-power-platform-app.png)
...
![The data model configured to store the data of my resume](/content/posts/resume-data-model.png)
